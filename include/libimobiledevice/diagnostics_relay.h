 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_restart(diagnostics_relay_client_t client, int flags);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_shutdown(diagnostics_relay_client_t client, int flags);

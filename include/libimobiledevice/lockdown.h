 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_client_new(idevice_t device, lockdownd_client_t *client, const char *label);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_client_new_with_handshake(idevice_t device, lockdownd_client_t *client, const char *label);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_client_free(lockdownd_client_t client);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_query_type(lockdownd_client_t client, char **type);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_get_value(lockdownd_client_t client, const char *domain, const char *key, plist_t *value);
 ...
 *  value is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_set_value(lockdownd_client_t client, const char *domain, const char *key, plist_t value);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_remove_value(lockdownd_client_t client, const char *domain, const char *key);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_start_service(lockdownd_client_t client, const char *identifier, lockdownd_service_descriptor_t *service);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_start_service_with_escrow_bag(lockdownd_client_t client, const char *identifier, lockdownd_service_descriptor_t *service);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_start_session(lockdownd_client_t client, const char *host_id, char **session_id, int *ssl_enabled);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_stop_session(lockdownd_client_t client, const char *session_id);
 ...
 *  plist is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_send(lockdownd_client_t client, plist_t plist);
 ...
 *  plist is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_receive(lockdownd_client_t client, plist_t *plist);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_pair(lockdownd_client_t client, lockdownd_pair_record_t pair_record);
 ...
 *  LOCKDOWN_E_INVALID_HOST_ID if the device does not know the caller's host id
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_validate_pair(lockdownd_client_t client, lockdownd_pair_record_t pair_record);
 ...
 *  LOCKDOWN_E_INVALID_HOST_ID if the device does not know the caller's host id
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_unpair(lockdownd_client_t client, lockdownd_pair_record_t pair_record);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_activate(lockdownd_client_t client, plist_t activation_record);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_deactivate(lockdownd_client_t client);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_enter_recovery(lockdownd_client_t client);
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_goodbye(lockdownd_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_get_device_udid(lockdownd_client_t control, char **udid);
 ...
 * @return LOCKDOWN_E_SUCCESS on success
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_get_device_name(lockdownd_client_t client, char **device_name);
 ...
 *  LOCKDOWN_E_PLIST_ERROR if the received plist is broken
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_get_sync_data_classes(lockdownd_client_t client, char ***classes, int *count);
 ...
 * @return LOCKDOWN_E_SUCCESS on success
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_data_classes_free(char **classes);
 ...
 * @return LOCKDOWN_E_SUCCESS on success
 */
LIBIMOBILEDEVICE_API_WIN32 lockdownd_error_t lockdownd_service_descriptor_free(lockdownd_service_descriptor_t service);

 ...
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_client_new(idevice_t device, lockdownd_service_descriptor_t service, misagent_client_t *client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_client_start_service(idevice_t device, misagent_client_t* client, const char* label);
 ...
 *     client is NULL, or an MISAGENT_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_client_free(misagent_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_install(misagent_client_t client, plist_t profile);
 ...
 *     empty array.
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_copy(misagent_client_t client, plist_t* profiles);
 ...
 *     client is invalid, or an MISAGENT_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 misagent_error_t misagent_remove(misagent_client_t client, const char* profileID);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 int misagent_get_status_code(misagent_client_t client);

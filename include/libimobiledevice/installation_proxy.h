 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_command_get_name(plist_t command, char** name);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_status_get_name(plist_t status, char **name);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_status_get_current_list(plist_t status, uint64_t* total, uint64_t* current_index, uint64_t* current_amount, plist_t* list);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_status_get_percent_complete(plist_t status, int *percent);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 plist_t instproxy_client_options_new(void);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_client_options_add(plist_t client_options, ...);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_client_options_set_return_attributes(plist_t client_options, ...);
 ...
 *        is passed.
 */
LIBIMOBILEDEVICE_API_WIN32 void instproxy_client_options_free(plist_t client_options);

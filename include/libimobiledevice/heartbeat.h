 ...
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_client_new(idevice_t device, lockdownd_service_descriptor_t service, heartbeat_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_client_start_service(idevice_t device, heartbeat_client_t * client, const char* label);
 ...
 *     client is NULL, or an HEARTBEAT_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_client_free(heartbeat_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_send(heartbeat_client_t client, plist_t plist);
 ...
 *  HEARTBEAT_E_INVALID_ARG when client or plist is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_receive(heartbeat_client_t client, plist_t * plist);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 heartbeat_error_t heartbeat_receive_with_timeout(heartbeat_client_t client, plist_t * plist, uint32_t timeout_ms);

 ...
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_client_new(idevice_t device, lockdownd_service_descriptor_t service, service_client_t *client);
 ...
 *     otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_client_factory_start_service(idevice_t device, const char* service_name, void **client, const char* label, int32_t (*constructor_func)(idevice_t, lockdownd_service_descriptor_t, void**), int32_t *error_code);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_client_free(service_client_t client);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_send(service_client_t client, const char *data, uint32_t size, uint32_t *sent);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_receive_with_timeout(service_client_t client, char *data, uint32_t size, uint32_t *received, unsigned int timeout);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_receive(service_client_t client, char *data, uint32_t size, uint32_t *received);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_enable_ssl(service_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 service_error_t service_disable_ssl(service_client_t client);

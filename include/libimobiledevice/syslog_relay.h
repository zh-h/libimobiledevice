 ...
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_client_new(idevice_t device, lockdownd_service_descriptor_t service, syslog_relay_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_client_start_service(idevice_t device, syslog_relay_client_t * client, const char* label);
 ...
 *     client is NULL, or an SYSLOG_RELAY_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_client_free(syslog_relay_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_start_capture(syslog_relay_client_t client, syslog_relay_receive_cb_t callback, void* user_data);
 ...
 *      error occurs or a syslog capture has already been started.
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_stop_capture(syslog_relay_client_t client);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_receive_with_timeout(syslog_relay_client_t client, char *data, uint32_t size, uint32_t *received, unsigned int timeout);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 syslog_relay_error_t syslog_relay_receive(syslog_relay_client_t client, char *data, uint32_t size, uint32_t *received);

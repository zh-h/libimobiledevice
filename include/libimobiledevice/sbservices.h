 ...
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_client_new(idevice_t device, lockdownd_service_descriptor_t service, sbservices_client_t *client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_client_start_service(idevice_t device, sbservices_client_t* client, const char* label);
 ...
 *     client is NULL, or an SBSERVICES_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_client_free(sbservices_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_get_icon_state(sbservices_client_t client, plist_t *state, const char *format_version);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_set_icon_state(sbservices_client_t client, plist_t newstate);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_get_icon_pngdata(sbservices_client_t client, const char *bundleId, char **pngdata, uint64_t *pngsize);
 ...
 *     client or state is invalid, or an SBSERVICES_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_get_interface_orientation(sbservices_client_t client, sbservices_interface_orientation_t* interface_orientation);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 sbservices_error_t sbservices_get_home_screen_wallpaper_pngdata(sbservices_client_t client, char **pngdata, uint64_t *pngsize);

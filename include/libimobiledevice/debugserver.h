 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_new(idevice_t device, lockdownd_service_descriptor_t service, debugserver_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_start_service(idevice_t device, debugserver_client_t * client, const char* label);
 ...
 *     client is NULL, or an DEBUGSERVER_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_free(debugserver_client_t client);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_send(debugserver_client_t client, const char* data, uint32_t size, uint32_t *sent);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_receive_with_timeout(debugserver_client_t client, char *data, uint32_t size, uint32_t *received, unsigned int timeout);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_receive(debugserver_client_t client, char *data, uint32_t size, uint32_t *received);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_send_command(debugserver_client_t client, debugserver_command_t command, char** response);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_receive_response(debugserver_client_t client, char** response);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_set_ack_mode(debugserver_client_t client, int enabled);
 ...
 *  DEBUGSERVER_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_set_argv(debugserver_client_t client, int argc, char* argv[], char** response);
 ...
 *  DEBUGSERVER_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_client_set_environment_hex_encoded(debugserver_client_t client, const char* env, char** response);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_command_new(const char* name, int argc, char* argv[], debugserver_command_t* command);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 debugserver_error_t debugserver_command_free(debugserver_command_t command);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void debugserver_encode_string(const char* buffer, char** encoded_buffer, uint32_t* encoded_length);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 void debugserver_decode_string(const char *encoded_buffer, size_t encoded_length, char** buffer);

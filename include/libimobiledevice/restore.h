 ...
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_client_new(idevice_t device, restored_client_t *client, const char *label);
 ...
 * @return RESTORE_E_SUCCESS on success, RESTORE_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_client_free(restored_client_t client);
 ...
 * @return RESTORE_E_SUCCESS on success, RESTORE_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_query_type(restored_client_t client, char **type, uint64_t *version);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_query_value(restored_client_t client, const char *key, plist_t *value);
 ...
 * @return RESTORE_E_SUCCESS on success, RESTORE_E_INVALID_ARG when client is NULL, RESTORE_E_PLIST_ERROR if value for key can't be found
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_get_value(restored_client_t client, const char *key, plist_t *value) ;
 ...
 *  plist is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_send(restored_client_t client, plist_t plist);
 ...
 *  plist is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_receive(restored_client_t client, plist_t *plist);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_goodbye(restored_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_start_restore(restored_client_t client, plist_t options, uint64_t version);
 ...
 *  is NULL
 */
LIBIMOBILEDEVICE_API_WIN32 restored_error_t restored_reboot(restored_client_t client);
 ...
 *
 */
LIBIMOBILEDEVICE_API_WIN32 void restored_client_set_label(restored_client_t client, const char *label);
